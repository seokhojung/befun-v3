    ...
    <main className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="text-center">
          <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-6">BeFun v3</h1>
          <p className="text-xl md:text-2xl text-gray-600 mb-8">3D 책상 컨피규레이터 플랫폼</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16">
          ...
          <div className="bg-white rounded-xl p-8 shadow-lg">
            <div className="w-16 h-16 bg-purple-100 rounded-full flex items-center justify-center mb-6">
              {/* react-icons 사용 예시: BiMeteor */}
              <BiMeteor size={32} className="text-purple-600" />
            </div>
